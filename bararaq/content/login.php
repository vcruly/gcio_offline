    ...
    <div class="card-body">
        ...
        <form method="post">
            ...
            <div class="d-grid mt-3">
                <button type="submit" class="btn btn-primary fw-semibold py-2">Acceder al sistema</button>
            </div>
        </form>

        <p class="text-muted text-center mt-4 mb-0">
            Nuevo aqui? <a href="registro.php" class="text-decoration-underline link-offset-3 fw-semibold">Registra tu cuenta desde la nube</a>
        </p>
